...
C:\Users\vimanyua\.conda\envs\skills_env\python.exe "C:\Users\vimanyua\PycharmProjects\Pipeline\skills_data\put_file_in_s3.py" "skills" > "C:\Users\vimanyua\PycharmProjects\Pipeline\skills_data\print_logs\%DATE:~-4%-%DATE:~4,2%-%DATE:~7,2%.log" 2>&1 %*
